...
(function () {
  ...
  var BRAND_IMAGES = [
    ...
    { key: 'authoring-agent-light', path: '/brand/authoring-agent-light.png', label: 'Authoring Agent (PNG fallback)' },
    { key: 'guidance-agent-light', path: '/brand/guidance-agent-light.png', label: 'Guidance Agent (PNG fallback)' },
    { key: 'insights-agent-light', path: '/brand/insights-agent-light.png', label: 'Insights Agent (PNG fallback)' },
